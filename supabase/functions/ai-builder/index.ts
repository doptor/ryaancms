...
serve(async (req) => {
  ...
  try {
        ...
        function: {
          ...
          parameters: {
            ...
            properties: {
              ...
              title: {
                type: "string",
                description: "A short title for the project"
              },
              description: {
                type: "string",
              ...
              modules: {
                ...
                items: {
                  type: "string",
                  enum: ["auth", "blog", "ecommerce", "crm", "analytics", "payments", "media", "forms", "api", "marketplace", "notifications", "search"]
                },
              ...
              features: {
                type: "array",
                items: { type: "string" },
                description: "Key features like multi-tenant, realtime, etc."
              },
              pages: {
                type: "array",
                items: {
                    ...
                    components: {
                      ...
                      items: {
                        ...
                        properties: {
                          type: {
                            type: "string",
                            enum: ["hero", "navbar", "footer", "sidebar", "crud_table", "form", "chart", "card_grid", "stats_row", "auth_form", "pricing_table", "media_gallery", "search_bar", "notification_center", "rich_text_editor", "file_upload", "calendar", "kanban_board", "timeline", "map"]
                          },
                          props: {
                            type: "object",
                            description: "Component configuration props"
                          }
                        },
                        required: ["type"],
                        additionalProperties: false
    ...
    if (!toolCall) {
      throw new Error("AI did not return structured config");
    }
