...
const seedData: AIIntegration[] = [
  { id: "agent-1", name: "Agent 1 — Requirement Analyst", provider: "gemini", model: "gemini-2.5-flash", apiEndpoint: "https://generativelanguage.googleapis.com", apiKey: "", status: "inactive", usageCount: 0, lastUsed: "-", createdAt: "2026-02-15", useFor: ["app_builder", "agent_1"] },
  { id: "agent-2", name: "Agent 2 — Product Manager", provider: "gemini", model: "gemini-2.5-flash", apiEndpoint: "https://generativelanguage.googleapis.com", apiKey: "", status: "inactive", usageCount: 0, lastUsed: "-", createdAt: "2026-02-15", useFor: ["app_builder", "agent_2"] },
  { id: "agent-3", name: "Agent 3 — Task Planner", provider: "gemini", model: "gemini-2.5-flash", apiEndpoint: "https://generativelanguage.googleapis.com", apiKey: "", status: "inactive", usageCount: 0, lastUsed: "-", createdAt: "2026-02-15", useFor: ["app_builder", "agent_3"] },
  { id: "agent-4", name: "Agent 4 — System Architect", provider: "anthropic", model: "claude-sonnet-4-20250514", apiEndpoint: "https://api.anthropic.com/v1", apiKey: "", status: "inactive", usageCount: 0, lastUsed: "-", createdAt: "2026-02-15", useFor: ["code_gen", "agent_4"] },
  { id: "agent-5", name: "Agent 5 — Database Agent", provider: "anthropic", model: "claude-sonnet-4-20250514", apiEndpoint: "https://api.anthropic.com/v1", apiKey: "", status: "inactive", usageCount: 0, lastUsed: "-", createdAt: "2026-02-15", useFor: ["code_gen", "agent_5"] },
  { id: "agent-6", name: "Agent 6 — Backend Agent", provider: "anthropic", model: "claude-sonnet-4-20250514", apiEndpoint: "https://api.anthropic.com/v1", apiKey: "", status: "inactive", usageCount: 0, lastUsed: "-", createdAt: "2026-02-15", useFor: ["code_gen", "agent_6"] },
  { id: "agent-7", name: "Agent 7 — UI/UX Designer", provider: "gemini", model: "gemini-2.5-flash", apiEndpoint: "https://generativelanguage.googleapis.com", apiKey: "", status: "inactive", usageCount: 0, lastUsed: "-", createdAt: "2026-02-15", useFor: ["app_builder", "agent_7"] },
